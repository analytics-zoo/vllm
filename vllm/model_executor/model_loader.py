...
from vllm.model_executor.models import BigDLLlamaForCausalLM, BigDLBloomForCausalLM  # pylint: disable=wildcard-import
...
_MODEL_REGISTRY = {
    ...
    "BloomForCausalLM": BigDLBloomForCausalLM,
