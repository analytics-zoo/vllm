...
class ModelInputForXPU(ModelRunnerInputBase):
    ...
    """
    # Tokens that are passed for handling...
    # 
...
class XPUModelRunner(ModelRunnerBase[ModelInputForXPU]):
    ...
    def prepare_model_input(
        ...
        # Set this to null.
        multi_modal_kwargs_list: Dict[str, List[torch.Tensor]] = defaultdict(list)
        ...
        # Currently, not supported multi_modal_kwargs
        ...
        # Return the ModelInputTensor

    def prepare_model_input_back(
            self,
            seq_group_metadata_list: List[SequenceGroupMetadata],
            virtual_engine: int = 0,
            finished_requests_ids: Optional[List[str]] = None
        ...
        # all decodes.
        is_prompt = seq_group_metadata_list[0].is_prompt
        print(f"!!!!!Here, is_prompt is {is_prompt}", flush=True)
        ...
        sampling_metadata = SamplingMetadata.prepare(
            ...
            self.device,
            pin_memory=False)
        print(f"original input_tokens' shape:{input_tokens.shape}")
    ...
    def _prepare_prompt(
        ...
        for seq_group_metadata in seq_group_metadata_list:
            ...
            # This is probably for chunked prefill, not used...
